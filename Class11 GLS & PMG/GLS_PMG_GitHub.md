...
$$\log(gdp\_pc_{it}) = \beta_0 + \beta_1 \log(gfcf\_pc_{it}) + \beta_2 \log(pop_{it}) + \beta_3 \log(trade_{it}) + \beta_4 \log(agri_{it}) + \beta_5 \log(ser_{it}) + \beta_6 \log(ind_{it}) + u_{it}$$
...
$$\log(gdp\_pc_{it}) = \alpha_i + \beta_1 \log(gfcf\_pc_{it}) + \beta_2 \log(pop_{it}) + \beta_3 \log(trade_{it}) + \beta_4 \log(agri_{it}) + \beta_5 \log(ser_{it}) + \beta_6 \log(ind_{it}) + u_{it}$$
...
$$\log(gdp\_pc_{it}) = \beta_0 + \beta_1 \log(gfcf\_pc_{it}) + \beta_2 \log(pop_{it}) + \beta_3 \log(trade_{it}) + \beta_4 \log(agri_{it}) + \beta_5 \log(ser_{it}) + \beta_6 \log(ind_{it}) + u_i + \epsilon_{it}$$
...
[Complex HTML table removed - see original file or HTML output]
